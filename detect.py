...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='save_mdoels/res101s.pt', help='model.pt path')
    ...
    with torch.no_grad():
        if opt.update:  # update all models (to fix SourceChangeWarning)
            for opt.weights in ['rcnnv5s.pt', 'rcnnv5m.pt', 'rcnnv5l.pt', 'rcnnv5x.pt', 'rcnnv3-spp.pt']:
                detect()

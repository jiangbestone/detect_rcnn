...
def attempt_download(weights):
    ...
    if len(weights) > 0 and not os.path.isfile(weights):
        d = {'rcnnv3-spp.pt': '1mM67oNw4fZoIOL1c8M3hHmj66d8e-ni_',
             'res50.pt': '1R5T6rIyy3lLwgFXNms8whc-387H0tMQO',
             'rcnnv5m.pt': '1vobuEExpWQVpXExsJ2w-Mbf3HJjWkQJr',
             'rcnnv5l.pt': '1hrlqD1Wdei7UT4OgT785BEk1JwnSvNEV',
             'rcnnv5x.pt': '1mM8aZJlWTxOg7BZJvNUMrTnA2AbeCVzS',
             }
        ...
        if not (r == 0 and os.path.exists(weights) and os.path.getsize(weights) > 1E6):  # weights exist and > 1MB
            ...
            s = "curl -L -o %s 'https://storage.googleapis.com/ultralytics/rcnnv5/ckpt/%s'" % (weights, file)
